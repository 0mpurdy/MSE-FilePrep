...
*/
    ...
    public void actionPerformed (ActionEvent e) {
        ...
        if (buttonSource == buttonPrepare) {
            ...
            try {
                File fIndex = new File("c:\\mse\\target\\bible\\superset.idx");
                if (fIndex.exists()) {
                ...
                new Alert("Error", "Error reading superset index (c:\\mse\\target\\bible\\superset.idx)");
            ...
            String strAuth = comboAuth.getSelectedItem().toString().toLowerCase();
            String strUntidyVolsPath = "c:\\mse\\src\\" + strAuth + "\\best\\";
            String strBackupVolsPath = "c:\\mse\\src\\" + strAuth + "\\orig\\";
    ...
    private void createBibleHTML() {
        try {
            String strJNDPath = "c:\\mse\\src\\bible\\best\\";
            String strKJVPath = "c:\\mse\\src\\kjv\\best\\";
            String strBibleDestPath = "c:\\mse\\target\\bible\\";
            String strBibleTxtDestPath = "c:\\mse\\src\\bible\\txt\\";
...
//                              taOutput.append(NEW_LINE + "Synopsis page for " + x + "/" + strChapter + " = " + strSynopsisLink);
    ...
    private void createHymnsHTML() {
        try {
            String strHymnsPath = "c:\\mse\\src\\hymns\\best\\";
            String strHymnsDestPath = "c:\\mse\\target\\hymns\\";
...
//        tfProgress.setText("Done");
    ...
    private void prepare(String strAuth) {
        ...
        int intVol = 0;
        int intSection = 1;
        String strVolsPath = "c:\\mse\\src\\" + strAuth + "\\best\\";
        String strVolsDestPath = "c:\\mse\\target\\" + strAuth + "\\";
...
//                                        strFootnotes = "";
    ...
    private void writeIndex(String strAuth) {
        ...
        String strVolsPath;
        if (!strAuth.equals("bible")) {
            strVolsPath = "c:\\mse\\src\\" + strAuth + "\\best\\";
        } else {
            strVolsPath = "c:\\mse\\src\\" + strAuth + "\\txt\\";
        }
        String strVolsDestPath = "c:\\mse\\target\\" + strAuth + "\\";
        String strIndexPath = "c:\\mse\\target\\" + strAuth + "\\";
...
taOutput.append(NEW_LINE + "Writing index ..." + saVolPages.length + ", " + laOffsets.length + ", " + laLengths.length);
    ...
    private void createSuperIndex() {
        ...
        try {
            ...
            FileOutputStream fosSSIndex = new  FileOutputStream("c:\\mse\\target\\bible\\superset.idx");
            ...
            oosSSIndex.flush();
            oosSSIndex.close();
            taOutput.append(NEW_LINE + NEW_LINE + "Wrote " + saSuperset.length + " words to superset index (" + "c:\\mse\\target\\bible\\superset.idx)");

            PrintWriter pwLog = new PrintWriter(new FileWriter("c:\\mse\\src\\superindex.doc", false));
